const DIAGRAM_DOCS = {
  flowchart: {
    ...
    header: 'flowchart LR',
    purpose: 'Use for DFD Level 0, DFD Level 1, and trust-boundary views.',
    constructs: [
  ...
  sequenceDiagram: {
    ...
    purpose: 'Use for the highest-risk interaction flows such as login, admin actions, or data export.',
    constructs: [
      ...
      'Use `alt`, `opt`, `loop`, `par`, `critical`, or `rect` blocks with a closing `end`.',
  ...
  erDiagram: {
    ...
    header: 'erDiagram',
    purpose: 'Use when data classification or ownership is easier to explain as datastore relationships.',
    constructs: [
